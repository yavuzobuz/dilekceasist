...
Kritik kurallar:
1. Once hukuki nitelendirme yap. Jenerik terim kullanma.
2. initialKeyword 1-3 kelime olsun ve legalDiagnosis icinden ciksin.
3. searchClauses, diagnosis etrafinda Bedesten aramasi icin yararli olsun.
4. Kullanici hedefini (varsa) negativeConcepts icine yazma.
5. requestedRelief alanini mutlaka doldur.
6. diagnosisConfidence 0 ile 1 arasinda sayi olsun.
7. Mutlaka ve sadece ${strategyCount} adet strateji iceren bir JSON dizisi dondur!
