    ...
    <div className="bg-gradient-to-br from-black via-gray-900 to-black rounded-xl shadow-2xl shadow-red-900/10 flex flex-col h-full min-h-[500px] lg:min-h-0 border border-gray-800/50">
      <div className="flex items-center justify-between border-b border-gray-800 px-4">
        ...
        <div className="flex items-center gap-2">
          {/* Full-page expand button - only show on petition tab when there's content */}
          {activeTab === 'petition' && props.generatedPetition && props.onExpandFullPage && (
            <button
              onClick={props.onExpandFullPage}
              className="px-3 py-2 text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center gap-2"
